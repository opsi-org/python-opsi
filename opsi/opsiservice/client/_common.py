...
from opsi.opsiservice.config import OPSI_CA_CERT_FILE, OpsiConfig
from opsi.opsiservice.model.object import deserialize, serialize
from opsi.opsiservice.model.type import to_host_id, to_opsi_host_key
