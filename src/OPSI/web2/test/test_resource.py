...
"""
A test harness for OPSI.web2.resource.
"""
...
from OPSI.web2.http import Response
from OPSI.web2.stream import MemoryStream
from OPSI.web2.resource import RenderMixin, LeafResource
from OPSI.web2.server import Site, StopTraversal
