# -*- coding: utf-8 -*-
#
# opsi-auto-tests documentation build configuration file, created by
# sphinx-quickstart on Thu Sep  5 16:07:52 2013.
#
...
with open(os.path.join(os.path.dirname(__file__), "..", "..", "debian", "changelog")) as f:
    version_line = f.readline()
    # The short X.Y version.
    version = version_line.split('(')[1].split('-')[0]
    # The full version, including alpha/beta/rc tags.
    release = version_line.split('(')[1].split(')')[0]
...
exclude_patterns = ['_build', 'html', 'singlehtml']
...
latex_documents = [
  ('index', 'opsi.tex', u'OPSI Documentation',
   u'uib GmbH', 'manual'),
]
...
man_pages = [
    ('index', 'opsi', u'OPSI Documentation',
     [u'uib GmbH'], 1)
]
...
texinfo_documents = [
  ('index', 'opsi', u'OPSI Documentation',
   u'uib GmbH', 'opsi', 'OPSI client management tool.',
   'Miscellaneous'),
]
