...
@pytest.mark.parametrize(
	...
	[
		...
		[False, "/var/lib/tftpboot/opsi/pxelinux.cfg/default.menu", "/var/lib/tftpboot/grub/grub.cfg"],
	],
)
...
def testPatchServiceUrlInDefaultConfigs(backendManager, tempDir):
	...
	clientconfigConfigserverUrl = UnicodeConfig(id="clientconfig.configserver.url", possibleValues=[], defaultValues=[testIp])
