...
def getConfigs(depotServerId=None):
	...
	config6 = UnicodeConfig(id="%username%", description="username", possibleValues=None, defaultValues=["opsi"])
...
def getConfigStates(configs, clients, depotserver):
	...
	configState4 = ConfigState(
		configId=config6.getId(), objectId=client2.getId(), values=["-------- test --------\n4: %4\n1: %1\n2: %2\n5: %5"]
	)
	...
	return (configState1, configState2, configState3, configState4, configState5, configState6, configState7)
...
def testConfigStateGetObjectsIncludesDefaultValues(extendedConfigDataBackend):
	...
	config = UnicodeConfig(id="democonfig", editable=False, multiValue=False, possibleValues=[0, 5], defaultValues=[5])
